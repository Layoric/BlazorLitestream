...
##  [/BlazorLitestream.Client](https://github.com/NetCoreTemplates/blazor-wasm/tree/main/BlazorLitestream.Client)
...
## [/BlazorLitestream](https://github.com/NetCoreTemplates/blazor-wasm/tree/main/BlazorLitestream)

The .NET 6 `/BlazorLitestream` backend server is required for this App's dynamic functions including the Hello API on the home page
